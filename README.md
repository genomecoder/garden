...
- **Multiple shape types** — Rectangle, circle, triangle, L-shape, raised bed plus shed (with roof, door, and windows), fence, path/walkway, pond/fountain, compost bin, tree, garden bench, and trellis
...
- **Notes and annotations** — Add draggable text notes to the canvas via the toolbar; double-click to edit, clear text to delete
