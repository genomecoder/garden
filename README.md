...
- **Multiple shape types** — Rectangle, circle, triangle, L-shape, raised bed plus shed (with roof, door, and windows), fence, path/walkway, pond/fountain, compost bin, tree, and garden bench
