...
export function GardenBedComponent({
  ...
  return (
    ...
    >
      ...
      {bed.shape === 'bird-bath' && (() => {
        const cx = bed.width / 2;
        // Layout: base plate at bottom, column in middle, basin at top
        const basePlateY = bed.height * 0.85;
        const basePlateW = bed.width * 0.5;
        const basePlateH = bed.height * 0.15;
        const columnW = bed.width * 0.14;
        const columnTop = bed.height * 0.35;
        const columnH = basePlateY - columnTop;
        const basinY = bed.height * 0.3;
        const basinRx = bed.width * 0.45;
        const basinRy = bed.height * 0.2;
